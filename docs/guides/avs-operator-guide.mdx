...
Operators that want to quickly deploy a production ready environment using Docker Compose and AWS may wish to use the [Docker Compose quickstart guide](../operate/docker-quickstart.mdx).
...
You can read more about the AVS protocol design [here](/docs/protocol/economic-security/hyperlane-avs.mdx).
